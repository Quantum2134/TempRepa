...
namespace EngineCore.Graphics
{
    public class Renderer
    {
        ...
        public void DrawTexture(Texture texture, Color4 color, Vector2 position, Vector2 scale, float z)
        {
            textureShader.Bind();
            textureVao.Bind();
            textureVbo.Bind();
            ...
            textureVertices[0].position = new Vector3(position.X, position.Y, z) - new Vector3(scale.X, scale.Y, z) / 2;
            textureVertices[0].Color = color;
            textureVertices[0].uv = new Vector2(0, 0);

            textureVertices[1].position = new Vector3(position.X, position.Y, z) + new Vector3(-scale.X / 2, scale.Y / 2, z);
            textureVertices[1].Color = color;
            textureVertices[1].uv = new Vector2(0, 1);

            textureVertices[2].position = new Vector3(position.X, position.Y, z) + new Vector3(scale.X, scale.Y, z) / 2;
            textureVertices[2].Color = color;
            textureVertices[2].uv = new Vector2(1, 1);

            textureVertices[3].position = new Vector3(position.X, position.Y, z) + new Vector3(scale.X, -scale.Y, z) / 2;
            textureVertices[3].Color = color;
            textureVertices[3].uv = new Vector2(1, 0);
